...
class AllProductsSection extends Component {
  state = {
    ...
    categorySelected: '',
    ratingSelected: '',
    fetchResult: fetchResultsConstants.initial,
  }
  ...
  getProducts = async () => {
    ...
    // TODO: Update the code to get products with filters applied -->>done
  ...
  displayFailureFetchView = () => (
    <div className="all-products-container">
      <div className="failure-view-container">
        ...
        <p className="failure-fetch-description-1">
  ...
  renderProductsList = () => {
    ...
    switch (fetchResult) {
      case fetchResultsConstants.success:
        return this.displaySuccessfulFetchView()
      case fetchResultsConstants.failed:
        return this.displayFailureFetchView()
      case fetchResultsConstants.noProducts:
        return this.displayNoProductsView()
      default:
        return null
    }
  }
